#!/usr/bin/env python3
"""
Script to run PageRank benchmarks comparing traditional and multiprocessing
...
def main():
    parser = argparse.ArgumentParser(description='Run PageRank benchmarks for traditional and multiprocessing')
